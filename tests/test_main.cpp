...
int main()
{
    try
    {
        ...
        md::test::testLobModifyUnknownOrderWithoutFullStateIsSkipped();
        md::test::testLobUnknownOrderDiagnosticsAreRateLimited();
        md::test::testLobBidAskViewsIterateWithoutCopy();
        ...
        md::test::testDispatchSequenceSemantics();
        md::test::testCanonicalDomainTypes();
        md::test::testCheckedTimestampAndLatencyArithmetic();
        md::test::testMarketDataEnvelopeSemantics();
        md::test::testMarketDataEnvelopeProcessorCompatibility();
        ...
        md::test::testStandardRunnerDispatchEnvelopes();
        md::test::testRepeatedStandardRunnerDispatchSequencesRestart();
        md::test::testFlatAndHierarchyDispatchEnvelopesMatch();
        md::test::testEqualTimestampDispatchOrderRemainsDeterministic();
        md::test::testLegacyProcessorRemainsRunnerCompatible();
